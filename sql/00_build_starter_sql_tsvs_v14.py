...
def build_window_tables(
    ...
    if allowed_types == ["chromosome"]:
        seq_scope = "chromosome_only"
    
    elif allowed_types == ["scaffold"]:
        seq_scope = "scaffold_only"
    
    elif allowed_types == ["chromosome", "scaffold"]:
        seq_scope = "chromosome_plus_scaffold"
    
    elif allowed_types == ["chromosome", "mitochondrion", "scaffold"]:
        seq_scope = "all_sequences"
    
    else:
        seq_scope = "_plus_".join(allowed_types)
    # to here
