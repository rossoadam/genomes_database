...
20260619
	Rerunning a version 4 of 03_make_master_input_tsvs.py which adds the following natural history traits:

  max_mass_grams_oskyrko double
  max_female_length_svl_mm double
  largest_clutch_size double
  mean_number_of_eggs_per_clutch double
  max_longevity_years interger
  number_clutches_per_year double
  
  I moved all the previous output from this script to the following directory
  
  /Users/rossoaa/projects/genomes/records/gc_metrics_inputs/archive
  ...
  the command I am running is:
    ...
    --traits-oskyrko /path/to/oskyrko_et_al_2024_repttraits.csv \
    --mass-title /path/to/title.csv \
    --mass-ji /path/to/ji.tsv \
    --thermal-bennett /path/to/bennett.csv

python 03_make_master_input_tsvs.py /Users/rossoaa/projects/genomes \
...
--genome-size /Users/rossoaa/projects/genomes/records/natural_history/reptile_summary/species_summary.csv \
--traits-oskyrko /Users/rossoaa/projects/genomes/records/natural_history/oskyrko_et_al_2024_repttraits.csv \
--mass-title /Users/rossoaa/projects/genomes/records/natural_history/title_at_al_data.csv \
--mass-ji /Users/rossoaa/projects/genomes/records/natural_history/ji_et_al.tsv \
--thermal-bennett /Users/rossoaa/projects/genomes/records/natural_history/bennett_et_al_2019_globaltherm_upload_10_11_17.csv

Here was the output to the terminal:

[OK] Loaded 84 focal species from /Users/rossoaa/projects/genomes/records/project_manifests/mass_predicts_dna_dynamics_with_s_punctatus_manifest.csv (manifest)
[OK] Wrote /Users/rossoaa/projects/genomes/records/gc_metrics_inputs/genome_sizes.tsv (17/84 species matched)
[OK] Wrote /Users/rossoaa/projects/genomes/records/gc_metrics_inputs/species_mass.tsv (oskyrko_mass=80, title_mass=81, ji_mass=1, preferred=83/84; preferred priority=oskyrko>title>ji)
[INFO] Trait matches: svl_oskyrko=52, svl_title=81, annual_eggs=39, range_size=79
[OK] Wrote /Users/rossoaa/projects/genomes/records/gc_metrics_inputs/thermal_limits.tsv (ctmax=19/84, ctmin=11/84)
[DONE] Natural-history TSV input staging complete.
[INFO] Output directory: /Users/rossoaa/projects/genomes/records/gc_metrics_inputs
[INFO] Canonical join key: species_normalized
