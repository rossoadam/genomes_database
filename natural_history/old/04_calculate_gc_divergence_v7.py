...
def apply_user_added_mass_overrides(
    ...
    append_missing_user_added_species: bool = True,
) -> pd.DataFrame:
    """
...
class NhPhymlGcDivergence:
    ...
    def export_master(self, gc3_summary: pd.DataFrame, dianc_df: pd.DataFrame) -> None:
        ...
        master = apply_user_added_mass_overrides(master, species_metadata=manifest_df, append_missing_user_added_species=True)
