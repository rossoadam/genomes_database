...
Important update:
  - number_of_species is now a REQUIRED positional argument.
...
Example:
  python 04_calculate_gc_divergence.py /path/to/genomes 58 \
    ...
    def export_master(self, gc3_summary: pd.DataFrame, dianc_df: pd.DataFrame) -> None:
        ...
        if manifest_df is not None:
            if self.include_all_manifest_species:
                ...
                master = master.merge(manifest_df, on="genus_species", how="left")
